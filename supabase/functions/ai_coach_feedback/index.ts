...
const handler = async (req) => {
  try{
    ...
    let functionName = "match_user_progress";
    ...
    const summary = results?.length
      ...
      : "No logs found.";
    //gemini proj
    const prompt = ` you are a fitness AI coach helping the user understand their progress.
    here are the matched logs:
    ${summary}
    User question: "${query}"

    Give a helpful analysis and recommendation in 3-5 sentences. Mention dates and trends clearly.
    `;
